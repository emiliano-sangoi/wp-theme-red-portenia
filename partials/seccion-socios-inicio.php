<div class="container">
    ...
    <!--                        <a href="-->
    <?php //echo site_url('/socios') ?><!--" class="btn btn-navy stretched-link">-->
    <!--                            Ver socios-->
    <!--                        </a>-->
    <!--                    </div>-->
    <!--                </div>-->
    ...
    <!--                    <div class="card-footer border-top-0 bg-silver">-->
    <!--                        <a href="-->
    <?php //echo site_url('/sumate') ?><!--" class="btn btn-navy stretched-link">-->
    ...
    <div class="card-group mt-5">
        <div class="card text-center bg-transparent border-0">
            <div class="card-header border-bottom-0">
                        <span class="fa-stack fa-3x" data-clear="card-img-top">
                            <i class="fas fa-circle fa-stack-2x text-primary w-100"></i>
                            <i class="fas fa-people-group fa-stack-1x fa-inverse text-light"></i>
                        </span>
            </div>
        ...
        <div class="card text-center bg-transparent border-0">
            ...
            <div class="card-body bg-transparent py-4 px-3 px-lg-5">
                <h5 class="card-title">
                    Sumate!
                </h5>
                <p class="card-text">
                    Podes sumarte fácilmente completando un formulario con tus datos.
                </p>
            </div>
            <div class="card-footer border-0">
...
<div class="container-fluid">
    <div id="carouselSocios" class="carousel slide w-100 mt-2 mt-lg-3 pt-5" data-bs-ride="carousel">
