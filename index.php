...
<head>
    ...
    <link href="<?php echo RPT_THEME_DIR . '/style.css'; ?>" rel="stylesheet" />
</head>
<body id="page-top">
<!-- Navigation-->
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand" href="#page-top"><img src="<?php echo RPT_THEME_DIR . '/assets/img/navbar-logo.svg'; ?>" alt="..." /></a>
